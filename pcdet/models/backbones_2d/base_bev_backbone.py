...
#         spatial_features4x = data_dict['spatial_features4x']
#         ups = []
#         ret_dict = {}
#         x = spatial_features
...
#             x = self.deblocks[-1](x)
#         #y
#         y = spatial_features4x
#         for i in range(len(self.blocks)):
#             y = self.blocks[i](y)

#             stride = int(spatial_features.shape[2] / y.shape[2])
#             ret_dict['spatial_features_%dy' % stride] = y
#             if len(self.deblocks) > 0:
#                 ups.append(self.deblocks[i](y))
#             else:
#                 ups.append(y)
...
#         data_dict['spatial_features_2d4x'] = y
